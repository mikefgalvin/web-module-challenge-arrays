...
function copy(originalFlavors){
    ...
    // console.log('Copy of flavors array', newFlavors);
    return(newFlavors);
}    
...
// 1. Call it array[2]
// 2. Attaching the second variable with the index numbers
...
function removeFlavorByName(flavors, name){
    ...
    console.log('remove name', removeFlavorByName(originalFlavors, "Rocky Road"));
